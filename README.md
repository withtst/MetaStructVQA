...
├── entities_nonsub_mapping_table.json    # Entity name → TotalSegmentator English name mapping
│
...
│   ├── convert_type_2a_to_mf.py          # 2a → 2a_maskfree (mask-free) conversion
│   ├── convert_type_2b_to_mf.py          # 2b → 2b_maskfree (mask-free) conversion
│   ├── convert_type_2c_to_mf.py          # 2c → 2c_maskfree (mask-free) conversion
...
│       └── *_maskfree.json               # Mask-free version templates
│
└── examples/                             # Examples for each question type (CN + EN, 18 total)
    ├── cn/                               # Chinese examples (report_language: chinese)
    │   ├── type_1a_example.json
    │   ├── type_1b_example.json
    │   ├── type_2a_example.json
    │   ├── type_2a_maskfree_example.json
    │   ├── type_2b_example.json
    │   ├── type_2b_maskfree_example.json
    │   ├── type_2c_example.json
    │   ├── type_2c_maskfree_example.json
    │   └── type_3_example.json
    └── en/                                # English examples (report_language: english)
        ├── type_1a_example.json
        ├── type_1b_example.json
        ├── type_2a_example.json
        ├── type_2a_maskfree_example.json
...
# Generate mask-free versions (maskfree)
...
| **2a_maskfree** | Same as 2a | 4-choose-2 | CT | Mask-free version |
| **2b_maskfree** | Same as 2b | 2-choose-1 | CT | Mask-free version |
| **2c_maskfree** | Same as 2c | 4-choose-1 | CT + PET | Mask-free version |
